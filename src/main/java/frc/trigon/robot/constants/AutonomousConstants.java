...
public class AutonomousConstants {
    ...
    private static void configureEventMap() {
        ...
        EVENT_MAP.put("shoot-cude-3", SideShooter.getInstance().getSetTargetShooterStateCommand(SideShooterConstants.SideShooterState.HIGH, true));
        ...
        EVENT_MAP.put("shoot-cude-1-from-afar", SideShooter.getInstance().getSetTargetShooterStateCommand(SideShooterConstants.SideShooterState.HYBRID_FROM_AFAR, true));
    }
